...
void main() {
  ...
  E2.n(3); // Named constructor.
  E2.m(5, "Hello!"); // Named constructor with additional parameters.
...
extension type const E3._(int it) {
  E3() : this._(42);
  E3.otherName(this.it);
}

// 还可以完全隐藏构造函数，而不仅仅是定义一个新的构造函数，使用与类相同的私有构造函数语法_
extension type E4._(int i) {
  E4.fromString(String foo) : i = int.parse(foo);
}
